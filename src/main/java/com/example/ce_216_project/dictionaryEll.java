...
public class dictionaryEll {
            ...
            for (int a = 0; a < 5; a++) {
                switch (a) {
                    ...
                    case 1 -> {
                        ...
                        allTranslations.append(findWordFromEnglish(newWord, secondLanguage, stringLanguage, shortPathEngTur(newWord), limiterPathEngTur(newWord), fakeHeadWord));
                    }
                    case 2 -> {
                        secondLanguage = "fra";
    ...
    static int findLineInEnglish(String word, int startPoint, int limitPoint){
        ...
        String fileName = "src/main/resources/dictionaries/" + ell +"-eng"+placeHolder;
    ...
    static String getWordFromEnglish(int startLine){
        try(BufferedReader reader = new BufferedReader(new FileReader("src/main/resources/dictionaries/ell-eng.dict"))) {
            String line = "";
            String output = "";
