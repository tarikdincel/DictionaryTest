...
public class dictionaryEng {
    ...
    public String isItEnglish(String word){
        String language = "";
        String placeHolder = english(word);
        ...
        for (int a = 0; a < 6; a++) {
            switch (a) {
                case 0 -> {
                    ...
                    allTranslations += findWord(word, secondLanguage, stringLanguage, shortPathEngTur(word), limiterPathEngTur(word));
                }
                case 1 -> {
                    secondLanguage = "deu";
                    stringLanguage = "Deutsch";
                    allTranslations += findWord(word, secondLanguage, stringLanguage, halfSplitterEngGer(word), 10000000);
                }
                case 2 -> {
                    secondLanguage = "ell";
                    stringLanguage = "Modern Greek";
                    allTranslations += findWord(word, secondLanguage, stringLanguage, shortPathEngEll(word), limiterPathEngEll(word));
                }
                case 3 -> {
                    secondLanguage = "fra";
                    stringLanguage = "French";
                    allTranslations += findWord(word, secondLanguage, stringLanguage, shortPathEngFra(word), limiterPathEngFra(word));
                }
                case 4 -> {
                    secondLanguage = "ita";
                    stringLanguage = "Italian";
                    allTranslations += findWord(word, secondLanguage, stringLanguage, shortPathEngIta(word), limiterPathEngIta(word));
                }
                case 5 -> {
                    secondLanguage = "swe";
                    stringLanguage = "Swedish";
                    allTranslations += findWord(word, secondLanguage, stringLanguage, shortPathEngSwe(word), limiterPathEngSwe(word));
                }
            }
        }
