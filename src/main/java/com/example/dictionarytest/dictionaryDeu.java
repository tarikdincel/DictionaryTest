...
public class dictionaryDeu {
    ...
    public String isItDeutsch(String word){
        String language = "";
        String placeHolder = deutsch(word);
    ...
    static String deutsch(String word){
        ...
        for (int a = 0; a < 6; a++) {
            switch (a) {
                case 0 -> {
                    ...
                    allTranslations += findWord(word, secondLanguage, stringLanguage, 1, 10000000);
                }
                case 1 -> {
                    secondLanguage = "eng";
    ...
    static String findWord(String word, String secondLanguage, String stringLanguage, int startPoint, int limitPoint){
        ...
        String fileName = deu+"-"+secondLanguage+placeHolder;
